...
export const useVmResource = () => {
  ...
  const osOptions = [
  { value: EOS.ubuntu2404, label: "Ubuntu 24.04" },
  { value: EOS.ubuntu2204, label: "Ubuntu 22.04" },
  { value: EOS.ubuntu2004, label: "Ubuntu 20.04" },
  ...
  { value: EOS.win2019std, label: "Windows Server 2019 Std" },
  { value: EOS.win2022std, label: "Windows Server 2022 Std" },

  { value: EOS.edgeprotectv1, label: "Edge Protect v1" },
  { value: EOS.os3cx, label: "3CX" },
  { value: EOS.yeastar, label: "Yeastar" },
